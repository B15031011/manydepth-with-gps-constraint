...
class MonodepthOptions:
    def __init__(self):
        ...
        #additional options
        self.parser.add_argument("--using_probability_depth",
                                 action='store_true',
                                 help="If set, using weighted average method to calculate lowest_cost")
        self.parser.add_argument("--using_GTPose",
                                 action='store_true',
                                 help="If set, using GPS pose"
                                 )
        self.parser.add_argument("--using_scale_factor",
                                 action='store_true',
                                 help="If set, using scale factor"
                                 )
        # SYSTEM options
